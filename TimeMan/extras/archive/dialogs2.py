...
class DataWindow(wx.Frame):
    def __init__(self,parent,id,title):
        ...
        """
        self.data_list = wx.ListCtrl(self.panel,-1,pos=(10,10),size=(250,260),
                                     style=wx.LC_REPORT
                                     )"""
        #Part of trying to graph work flow
        self.data_list = wx.ListCtrl(self,-1,style=wx.LC_REPORT)
        #Add columns
        ...
        for x in xrange(len(days)):
            ...
            self.data_list.SetStringItem(x, 1, str(hours[x]))
...
#        plt.gca().xaxis.set_major_locator(mdates.DayLocator())
        ...
        self.Sizer.Add(self.data_list, 0, wx.EXPAND)
